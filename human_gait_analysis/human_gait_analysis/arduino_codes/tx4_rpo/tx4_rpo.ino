...
{  
get_imu_data();
temp4.pitch=int(y_theta);
temp4.roll=int(z_theta);
temp4.omega=GYRY;
//temp2.alpha=acc;
radio.write(&temp4, sizeof(temp4));
_print();
}

void _print()
{
  Serial.print("pitch=");Serial.print(temp4.pitch);
  Serial.print(" || roll=");Serial.print(temp4.roll);
  Serial.print(" || omega=");Serial.println(temp4.omega);

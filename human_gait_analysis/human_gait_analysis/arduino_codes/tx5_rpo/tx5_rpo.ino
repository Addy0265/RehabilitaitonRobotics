...
{  
get_imu_data();
temp5.pitch=int(y_theta);
temp5.roll=int(z_theta);
temp5.omega=GYRY;
//temp2.alpha=acc;
radio.write(&temp5, sizeof(temp5));
_print();
}

void _print()
{
  Serial.print("pitch=");Serial.print(temp5.pitch);
  Serial.print(" || roll=");Serial.print(temp5.roll);
  Serial.print(" || omega=");Serial.println(temp5.omega);

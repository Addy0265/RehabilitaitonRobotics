...
{  
get_imu_data();
temp0.pitch=int(y_theta);
temp0.roll=int(z_theta);
temp0.omega=GYRY;
//temp2.alpha=acc;
radio.write(&temp0, sizeof(temp0));
_print();
}

void _print()
{
  Serial.print("pitch=");Serial.print(temp0.pitch);
  Serial.print(" || roll=");Serial.print(temp0.roll);
  Serial.print(" || omega=");Serial.println(temp0.omega);

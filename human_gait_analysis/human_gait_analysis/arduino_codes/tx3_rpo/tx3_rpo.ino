...
{  
get_imu_data();
temp3.pitch=int(y_theta);
temp3.roll=int(z_theta);
temp3.omega=GYRY;
//temp2.alpha=acc;
...
void _print()
{
  Serial.print("pitch=");Serial.print(temp3.pitch);
  Serial.print(" || roll=");Serial.print(temp3.roll);
  Serial.print(" || omega=");Serial.println(temp3.omega);

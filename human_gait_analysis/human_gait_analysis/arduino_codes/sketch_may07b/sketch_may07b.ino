...
{  
get_imu_data();
temp1.pitch=int(y_theta);
temp1.roll=int(z_theta);
temp1.omega=GYRY;
//temp2.alpha=acc;
...
void _print()
{
  Serial.print("pitch=");Serial.print(temp1.pitch);
  Serial.print(" || roll=");Serial.print(temp1.roll);
  Serial.print(" || omega=");Serial.println(temp1.omega);
